...
public class Movingscript : MonoBehaviour {     // 이건 이상없음.
   ...
   /* public void CamOrigPos()
    {
        Cam.transform.position = Vector3.Lerp(Cam.transform.position, CamOriginPos, speed * Time.deltaTime);
    }*/
}
